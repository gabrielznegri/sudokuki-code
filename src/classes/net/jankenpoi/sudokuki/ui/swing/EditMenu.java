...
public class EditMenu extends JMenu implements L10nComponent {
	...
	public void setL10nMessages(Locale locale, String languageCode) {
		setText(_("Edit"));
		itemClearAllMoves.setText(_("Clear all moves"));
		itemEraseAllMemos.setText(_("Erase all memos..."));
...
//		itemCustomGrid.setIcon(StockIcons.ICON_EDIT);
...
//		itemPlayCustomGrid.setIcon(StockIcons.ICON_PLAY);
		itemPlayCustomGrid.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_H,
				ActionEvent.CTRL_MASK));
//		itemPlayCustomGrid.setMnemonic(KeyEvent.VK_H);
