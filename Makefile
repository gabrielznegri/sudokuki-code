...
pkgdatadir = $(datadir)/sudokuki
pkglibdir = $(libdir)/sudokuki
pkgincludedir = $(includedir)/sudokuki
...
PACKAGE_STRING = sudokuki 1.1.Beta6
PACKAGE_TARNAME = sudokuki
PACKAGE_VERSION = 1.1.Beta6
PATH_SEPARATOR = :
POSUB = po
RANLIB = ranlib
SED = /bin/sed
