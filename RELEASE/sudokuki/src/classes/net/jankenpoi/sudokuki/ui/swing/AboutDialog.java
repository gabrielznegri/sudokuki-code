...
public class AboutDialog extends JDialog {
	...
	private void initComponents() {
		...
		String license = null;
		try {
			license = readTextFile("text/COPYING");
		} catch (IOException e) {
		}
		...
		tabbedPane
				.addTab("Transfer",
						...
						makeTextPanel("<html>"
								...
								+ "<td>"
								+ "<p>"
								+ "<b>Sudokuki</b> is released under the terms of the GNU General Public<br/>"
								...
								+ "<td>"
								+ "<p>"
								+ "The full license text is available in the file called COPYING that<br/>"
								...
								+ "<td>"
								+ "<p>"
								+ "This program is Free Software (\"Free\" as in \"Freedom\") developped<br/>"
								+ "during the author's free-time in the hope that some users will find it<br/>"
								...
								+ "<td>"
								+ "<p>"
								+ "You are welcome to transfer this program to other people as long as<br/>"
								+ "you respect the license terms. Read the GNU General Public License<br/>"
								+ "for more details.<br/>"
								+ "</p>"
								+ "</td>"
								+ "</tr>"
	...
	protected JComponent makeFeedbackPanel(final URI forumURI) {
		...
		String feedbackStr = "<html>" + "<table border=\"0\">" + "<tr></tr>"
				...
				+ "Feel free to request features and report bugs<br/>"
				+ "on the Sudokuki Forums hosted by Sourceforge!<br/>"
				+ "</tr>" + "<tr>" + "</tr>" + "</table>" + "</html>";
		JLabel label = new JLabel(feedbackStr);
		label.setHorizontalAlignment(JLabel.CENTER);
